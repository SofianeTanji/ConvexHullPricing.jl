...
function HPO_fine_DA()
    # Saved value : α = 10
    FineParameterRangeBE = [5.0, 10.0, 15.0, 20.0, 25.0]
    FineResultsBE = []
...
function HPO_Coarse_SUBG()
    ...
    for α in CoarseParameterRange
        Xstar, Iterates, FunIterates, TimeVector =
            OPT.tnSubgradientMethod(instanceBE, X0BE, Τ, α)
        push!(CoarseResultsBE, [α, Xstar, Iterates, FunIterates, TimeVector])
    end
    ...
    for α in CoarseParameterRange
        Xstar, Iterates, FunIterates, TimeVector =
            OPT.tnSubgradientMethod(instanceCA, X0CA, Τ, α)
        push!(CoarseResultsCA, [α, Xstar, Iterates, FunIterates, TimeVector])
    end
...
function HPO_Coarse_SUBG_EP()
    ...
    for α in CoarseParameterRange
        @info "Testing α = $α"
        Xstar, Iterates, FunIterates, TimeVector =
            OPT.tEstimatedPolyak(instanceBE, X0BE, Τ, α)
        push!(CoarseResultsBE, [α, Xstar, Iterates, FunIterates, TimeVector])
    end
    ...
    for α in CoarseParameterRange
        @info "Testing α = $α"
        Xstar, Iterates, FunIterates, TimeVector =
            OPT.tEstimatedPolyak(instanceCA, X0CA, Τ, α)
        push!(CoarseResultsCA, [α, Xstar, Iterates, FunIterates, TimeVector])
    end
...
function HPO_Coarse_LSG()
    ...
    for α in CoarseParameterRange
        @info "Testing α = $α"
        Xstar, Iterates, FunIterates, TimeVector =
            OPT.tlastSubgradientMethod(instanceBE, X0BE, 900, α)
        push!(CoarseResultsBE, [α, Xstar, Iterates, FunIterates, TimeVector])
    end
    ...
    for α in CoarseParameterRange
        @info "Testing α = $α"
        Xstar, Iterates, FunIterates, TimeVector =
            OPT.tlastSubgradientMethod(instanceCA, X0CA, 600, α)
        push!(CoarseResultsCA, [α, Xstar, Iterates, FunIterates, TimeVector])
    end
...
function HPO_Coarse_BLM()
    ...
    for α in CoarseParameterRange
        @info "Testing α = $α"
        Xstar, Iterates, FunIterates, TimeVector =
            OPT.tBundleLevelMethod(instanceBE, X0BE, Τ, α)
        push!(CoarseResultsBE, [α, Xstar, Iterates, FunIterates, TimeVector])
    end
    ...
    for α in CoarseParameterRange
        @info "Testing α = $α"
        Xstar, Iterates, FunIterates, TimeVector =
            OPT.tBundleLevelMethod(instanceCA, X0CA, Τ, α)
        push!(CoarseResultsCA, [α, Xstar, Iterates, FunIterates, TimeVector])
    end
...
function HPO_Coarse_BPLM_B()
    ...
    for α in CoarseParameterRange
        @info "Testing α = $α"
        Xstar, Iterates, FunIterates, TimeVector =
            OPT.tBundleProximalLevelMethod(instanceBE, X0BE, Τ, α)
        push!(CoarseResultsBE, [α, Xstar, Iterates, FunIterates, TimeVector])
    end
    ...
    for α in CoarseParameterRange
        @info "Testing α = $α"
        Xstar, Iterates, FunIterates, TimeVector =
            OPT.tBundleProximalLevelMethod(instanceCA, X0CA, Τ, α)
        push!(CoarseResultsCA, [α, Xstar, Iterates, FunIterates, TimeVector])
    end
...
function HPO_Coarse_FGM()
    ...
    for α in CoarseParameterRange
        @info "Testing α = $α"
        Xstar, Iterates, FunIterates, TimeVector =
            OPT.tShiftedFGM(instanceBE, X0BE, Τ, α, 1e-8)
        push!(CoarseResultsBE, [α, Xstar, Iterates, FunIterates, TimeVector])
    end
    ...
    for α in CoarseParameterRange
        @info "Testing α = $α"
        Xstar, Iterates, FunIterates, TimeVector =
            OPT.tShiftedFGM(instanceCA, X0CA, Τ, α, 1e-8)
        push!(CoarseResultsCA, [α, Xstar, Iterates, FunIterates, TimeVector])
    end
