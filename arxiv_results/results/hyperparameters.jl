...
OptimalRTS = maximum(load_object("..//tests//UltraOptimalRunsRTS.jld2")[1][3])
OptUpliftsRTS = ObjMRTS - OptimalRTS


OptimalCA = maximum(load_object("..//tests//UltraOptimalRunsCA.jld2")[1][3])
